...
export const mockCoursesData: Record<"ar" | "en", Course[]> = {
  ar: [
    ...
    },
    {
      id: "course-006",
      coverImage: "/courses/physics.jpg",
      title: "المراجعة النهائية المكثفة - الفيزياء الحديثة",
      description:
        "### دورة المراجعة الشاملة للفيزياء الحديثة\n\nتغطي هذه الدورة جميع فصول الفيزياء الحديثة مع حل المسائل النموذجية والتدريب على نماذج الوزارة الاسترشادية.",
      previewVideoLink: "https://www.youtube.com/watch?v=u31qwQUeGuM",
      subject: "physics",
      grade: "grade3",
      teacherName: "أ. محمد عبد المعبود",
    ...
    },
    {
      id: "course-007",
      coverImage: "/courses/chemistry.jpg",
      title: "مسودة: مدخل إلى الكيمياء الكهربية والتحليلية",
      description:
        "### مسودة دورة الكيمياء الكهربية\n\nشرح تفصيلي للخلايا الجلفانية وخلايا التحليل الكهربي وتطبيقاتها الصناعية وحسابات قوانين فاراداي.",
      previewVideoLink: "",
      subject: "chemistry",
      grade: "grade3",
      teacherName: "د. إيهاب عبد العزيز",
  ...
  en: [
    ...
    },
    {
      id: "course-006",
      coverImage: "/courses/physics.jpg",
      title: "Intensive Final Revision - Modern Physics",
      description:
        "### Complete Revision Course for Modern Physics\n\nCovers all modern physics units with past national exam questions and guided problem solving.",
      previewVideoLink: "https://www.youtube.com/watch?v=u31qwQUeGuM",
      subject: "physics",
      grade: "grade3",
      teacherName: "Mr. Mohamed Abdel Maaboud",
    ...
    },
    {
      id: "course-007",
      coverImage: "/courses/chemistry.jpg",
      title: "Draft: Introduction to Electrochemistry & Analytics",
      description:
        "### Electrochemistry Course Draft\n\nDetailed breakdown of Galvanic and Electrolytic cells, industrial applications, and Faraday's laws calculations.",
      previewVideoLink: "",
      subject: "chemistry",
      grade: "grade3",
      teacherName: "Dr. Ihab Abdelaziz",
